...
<div class="wrapper">
    ...
    <div class="page-wrap">
        ...
        <div class="main-content">
            ...
            <form action="../../admin/create-exam/index.php" id='create-exam' method="POST">
                ...
                <div class="container-fluid">
                    ...
                    <div class=" mt-3 row clearfix">
                        <button type="submit" name="create_exam" value="1" class="m-2 ml-3 btn btn-success"><i
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        Swal.fire({
            title: '<h5> Do you want to load questions from the Question Bank? </h5>',
            ...
            if (result.isConfirmed) {
                window.location.href = '../../admin/create-exam/create-examqb.php'
